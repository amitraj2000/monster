...
//Tables
defined('USER_MASTER')      OR define('USER_MASTER', 'user_master'); 
...
//Uploads folder path
defined('UPLOADS')      OR define('UPLOADS', dirname(FCPATH).'/uploads/'); 
defined('UPLOADS_CATEGORY')      OR define('UPLOADS_CATEGORY', UPLOADS.'category/'); 
defined('UPLOADS_CATEGORY_THUMB')      OR define('UPLOADS_CATEGORY_THUMB', UPLOADS_CATEGORY.'thumbnail/'); 
defined('UPLOADS_PROVIDER')      OR define('UPLOADS_PROVIDER', UPLOADS.'provider/'); 
defined('UPLOADS_PROVIDER_THUMB')      OR define('UPLOADS_PROVIDER_THUMB', UPLOADS_PROVIDER.'thumbnail/'); 
defined('UPLOADS_MODEL')      OR define('UPLOADS_MODEL', UPLOADS.'model/'); 
